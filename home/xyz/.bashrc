...
for cmd in iotop nethogs hardcode-fixer ventoy du units_cur fbgrab powertop nft rpi-imager fdisk intel_gpu_top; do
	alias $cmd="sudo $cmd"
done
...
alias vj='$EDITOR "$XDG_DOCUMENTS_DIR/notes/computer/car_proj_notes.md"'
